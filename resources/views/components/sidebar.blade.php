<div class="sidebar bg-white border-r border-slate-100" id="sidebarPanel">
    ...
    <div class="sidebar-menu flex-1 px-3 md:px-4 space-y-1 overflow-y-auto scrollbar-hide">
        ...
        <a href="{{ route('dashboard') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('dashboard') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
        ...
        @if($isAdmin)
            ...
            <a href="{{ route('rooms.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('rooms.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
            ...
            <a href="{{ route('tenants.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('tenants.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
            ...
            <a href="{{ route('rentals.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('rentals.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
            ...
            <a href="{{ route('rent-payments.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('rent-payments.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
                <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('rent-payments.*') ? 'text-white' : 'text-slate-300 group-hover:text-brand-blue' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span class="text-sm font-bold truncate">Payments</span>
            </a>

            <div class="px-4 py-4 md:py-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Services</div>

            <a href="{{ route('admin.laundries.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.laundries.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
                <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.laundries.*') ? 'text-white' : 'text-slate-300 group-hover:text-brand-blue' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                <span class="text-sm font-bold truncate">Laundry Hub</span>
            </a>

            <a href="{{ route('admin.announcements.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.announcements.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
            ...
            <a href="{{ route('admin.cleaning.cleaners') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.cleaning.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
        ...
        @elseif(auth()->user()->role === 'laundry')
            <div class="px-4 py-4 md:py-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Laundry Dashboard</div>
            
            <a href="{{ route('laundry.orders.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('laundry.orders.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
            ...
            <a href="{{ route('laundry.services.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('laundry.services.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
        ...
        @elseif(auth()->user()->role === 'cleaner')
            <div class="px-4 py-4 md:py-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Cleaner Tasks</div>
            <a href="{{ route('cleaner.orders.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('cleaner.orders.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
        ...
        @if(!auth()->user()->isAdmin())
            <div class="px-4 py-4 md:py-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Information</div>
            <a href="{{ route('user.announcements.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('user.announcements.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
        ...
        @if(auth()->user()->role === 'user')
            <!-- User specific menu -->
            <div class="px-4 py-4 md:py-6 text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">My Services</div>
            @if(!$hasActiveRental)
            ...
            <a href="{{ route('rent-payments.my-payments') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('rent-payments.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
                <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('rent-payments.*') ? 'text-white' : 'text-slate-300 group-hover:text-brand-blue' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
                <span class="text-sm font-bold truncate">Tagihan Saya</span>
            </a>

            <a href="{{ route('user.laundry.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('user.laundry.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
            ...
            <a href="{{ route('user.cleaning.index') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all {{ request()->routeIs('user.cleaning.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
    ...
    <div class="p-4 md:p-6 border-t border-slate-50 mt-auto">
        <!-- Profile Link -->
        <a href="{{ route('profile.edit') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all mb-2 {{ request()->routeIs('profile.*') ? 'bg-brand-blue text-white shadow-lg shadow-blue-100' : 'text-slate-500 hover:bg-slate-50 hover:text-brand-blue' }}" onclick="closeSidebar()">
